                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="item-fl-box">
                                ...
                                <div class="brows-company-name">
                                    <h4><a href="company-detail.php">AutoDesk</a></h4>
                    ...
                    <div class="brows-company">
                        <div class="col-md-6 col-sm-6">
                            <div class="item-fl-box">
                                ...
                                <div class="brows-company-name">
                                    <h4><a href="company-detail.php">Honda</a></h4>
                    ...
                    <div class="brows-company">
                        <div class="col-md-6 col-sm-6">
                            <div class="item-fl-box">
                                ...
                                <div class="brows-company-name">
                                    <h4><a href="company-detail.php">Skype</a></h4>
                                    <span class="brows-company-tagline">Software Company</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="brows-company">
                        <div class="col-md-6 col-sm-6">
                            <div class="item-fl-box">
                                ...
                                <div class="brows-company-name">
                                    <h4><a href="company-detail.php">Virtue</a></h4>
                                    <span class="brows-company-tagline">Software Company</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="brows-company">
                        <div class="col-md-6 col-sm-6">
                            <div class="item-fl-box">
                                ...
                                <div class="brows-company-name">
                                    <h4><a href="company-detail.php">Twitter</a></h4>
                                    <span class="brows-company-tagline">Software Company</span>
                                </div>
                            </div>
                        </div>
