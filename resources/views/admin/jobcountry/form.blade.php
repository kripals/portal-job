                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <input type="text" name="title" class="form-control" required value="{{ old('title', isset($jobCountry->title) ? $jobCountry->title : '') }}"/>
                    ...
                    <div id="accordion1-1" class="collapse in">
                        <div class="card-actionbar">
                            <div class="card-actionbar-row">
                                <a class="btn btn-default btn-ink" href="{{ route('job-country.index') }}">
                            ...
                            <div class="side-label">
                                ...
                                <div class="label-body">
                                    <input type="checkbox" id="switch_demo_1" name="status"
                                           {{ old('status', isset($jobCountry->status) ? $jobCountry->status : '')=='active' ? 'checked':'' }} data-switchery/>
                                </div>
                            </div>
                            <div class="side-label">
                                <div class="label-head">
                                ...
                                <div class="label-body">
                                    <input type="checkbox" id="switch_demo_1" name="has_location"
                                           {{ old('has_location', isset($jobCountry->has_location) ? $jobCountry->has_location : '')=='yes' ? 'checked':'' }} data-switchery/>
                                </div>
                            </div>
                            <div class="side-label">
                                <div class="label-head">
                                ...
                                <div class="label-body">
                                    <input type="checkbox" id="switch_demo_1" name="is_home"
                                           {{ old('is_home', isset($jobCountry->is_home) ? $jobCountry->is_home : '')=='yes' ? 'checked':'' }} data-switchery/>
                                </div>
                            </div>
                        </div>
                    </div>
