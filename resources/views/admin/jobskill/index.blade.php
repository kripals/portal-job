    ...
    <section>
        <div class="section-body">
            <div class="row">
                <div class="card">
                    <div class="card-head">
                        <header class="text-capitalize">Job Skill</header>
                        <div class="tools">
                            <a class="btn btn-primary ink-reaction" href="{{ route('job-skill.create') }}">
                                <i class="md md-add"></i>
                                Add
                            </a>
                        </div>
