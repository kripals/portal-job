                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <input type="text" name="title" class="form-control" required value="{{ old('title', isset($educationBoard->title) ? $educationBoard->title : '') }}"/>
                    ...
                    <div id="accordion1-1" class="collapse in">
                        <div class="card-actionbar">
                            <div class="card-actionbar-row">
                                <a class="btn btn-default btn-ink" href="{{ route('job-level.index') }}">
                            ...
                            <div class="side-label">
                                ...
                                <div class="label-body">
                                    <input type="checkbox" id="switch_demo_1" name="status"
                                           {{ old('status', isset($educationBoard->status) ? $educationBoard->status : '')=='active' ? 'checked':'' }} data-switchery/>
                                </div>
                            </div>
                        </div>
                    </div>
