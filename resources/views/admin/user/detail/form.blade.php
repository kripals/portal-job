            ...
            <div class="user_heading" data-uk-sticky="{ top: 48, media: 960 }">
                <div class="user_heading_avatar fileinput fileinput-new" data-provides="fileinput">
                    <div class="fileinput-new thumbnail">
                        <img class="md-user-image" src="@if(str_contains($user->thumbnail_path,'.')){{asset($user->thumbnail_path)}} @else {{asset('resources/admin/assets/img/avatars/user.png')}} @endif" alt=""/></a>
                        ...
                        <div class="uk-margin-top">
                            ...
                            <div class="uk-grid" data-uk-grid-margin>
                                ...
                                <div class="uk-width-medium-1-2 parsley-row">
                                    ...
                                    <span class="icheck-inline">
                                        <input type="radio" name="marital_status" value="other" {{ old('marital_status', isset($userDetail->marital_status) ? $userDetail->marital_status : '')=='other' ? 'checked':'' }} id="radio_demo_inline_3"
                                               data-md-icheck required/>
