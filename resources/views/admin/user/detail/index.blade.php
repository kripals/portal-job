                        ...
                        <div class="user_heading ">
                            ...
                            <div class="user_heading_avatar">
                                <div class="thumbnail" style="cursor: pointer;"
                                    ...
                                    <img class="" src="@if(str_contains(Auth::user()->thumbnail_path,'.')){{asset(\Auth::user()->thumbnail_path)}} @else {{asset('resources/admin/assets/img/avatars/user.png')}} @endif" alt=""/></a>
{{--                                    <img src="{{asset($user->thumbnail_path)}}" alt="user avatar"/>--}}
                                ...
                                <div class="uk-modal" id="modal_lightbox{{$user->id}}">
                                    <div class="uk-modal-dialog uk-modal-dialog-lightbox">
                                        ...
                                        <img src="@if(str_contains(Auth::user()->thumbnail_path,'.')){{asset(\Auth::user()->thumbnail_path)}} @else {{asset('resources/admin/assets/img/avatars/user.png')}} @endif"     alt="">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="md-fab md-fab-toolbar md-fab-small md-fab-accent">
                                    ...
                                    <div class="md-fab-toolbar-actions">
                                        <a id="user_edit_save" data-uk-tooltip="{cls:'uk-tooltip-small',pos:'bottom'}"
                                           title="Edit"
                                           href="{{route('user.detail.edit', [$user->slug, $userDetail->id])}}">
