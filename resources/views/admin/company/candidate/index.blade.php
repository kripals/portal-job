    ...
    <section>
        <div class="section-body">
            <div class="row">
                <div class="card">
                    <div class="card-head">
                        <header class="text-capitalize">Candidates for (<a href="{{route('company.show',$company->id)}}">{{$company->company_name}}</a>)</header>
{{--                        <div class="tools">--}}
    ...
    <script>
        $(document).ready( function () {
            $('#tableData').DataTable({
                "processing": true,
                "serverSide": true,
                "ajax": '{{ route('company.candidate.data',$company->id)}}',
                columnDefs: [{
                    targets: -1,
